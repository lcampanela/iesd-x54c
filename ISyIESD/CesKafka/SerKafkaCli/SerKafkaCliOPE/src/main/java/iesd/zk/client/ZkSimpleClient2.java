...
public class ZkSimpleClient2 implements Watcher {

    protected final Logger LOG = Logger.getLogger(ZkSimpleClient2.class);

    final String ZOOKEEPER_SERVER = "siserver0.local:2181,siserver1.local:2181,siserver2.local:2181";
    ...
    public ZkSimpleClient2 () throws UnsupportedEncodingException {
